...
export const topicUsersRoomEmojiEndpoint = (code: string) => `/topic/users${roomEndpoint}/${code}/emoji`;
export const roomEmojiEndpoint = (code: string, emoji: string) => `${roomEndpoint}/${code}/emoji/${emoji}`;
